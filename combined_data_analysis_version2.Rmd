...
residential.bottom.graph <- ggplot(data=mobility.active.bottom,aes(x=mobility.mean,y=active.mean)) +
  geom_jitter(colour="dark green", alpha=0.7) +
  geom_smooth(method = "lm",
              formula = y ~ x,
              col = "dark green") +
  labs(x = "mobility.mean",
       y = "active.mean") +
  theme_bw() +
  ggtitle("linear regression of population density on mortality rates")

mobility.active.graph.bottom <- ggplot(data=mobility.active.bottom,aes(x=mobility.mean, y=active.mean)) +
#  geom_jitter(colour="dark green", alpha=0.7) +
  geom_smooth(method = "lm",
              formula = y ~ x,
              col = "dark green") +
