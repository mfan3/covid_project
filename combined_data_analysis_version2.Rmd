...
svi.pop.sig.top <- svi.mortality %>%
  slice_max(population.density, n = svi.sigl.crit)
svi.pop.sig.top.states = svi.pop.sig.top$STATE
# "New Jersey"    "Rhode Island"  "Massachusetts" "Connecticut"   "Maryland"    

svi.pop.sig.bottom <- svi.mortality %>%
  slice_min(population.density, n = svi.sigl.crit)
...
pop.graph <- ggplot(data=svi.mortality.pop,aes(x=population.density,y=mortality.avg)) +
#  geom_jitter(colour="dark green", alpha=0.7) +
  geom_smooth(method = "lm",
              formula = y ~ x,
              col = "dark green") +
...
mobility.active.top <- mobility.active %>%
  ...
  summarise(active.mean = active.avg,
            mobility.mean = mean(c(retail.recreation.avg, grocery.pharmacy.avg, parks.avg, transit.avg, workplace.avg, residential.avg)),
            retail.recreation.mean = mean(retail.recreation.avg),
            grocery.pharmacy.mean = mean(grocery.pharmacy.avg),
            parks.mean = mean(parks.avg),
            transit.mean = mean(transit.avg),
            workplace.mean = mean(workplace.avg),
            residential.mean = mean(residential.avg))

mobility.active.top.lm <- lm(active.mean ~ mobility.mean, data = mobility.active.top)
mobility.active.top.res <- residuals(mobility.active.top.lm)

# retail and recreation
retail.mobility.top.lm <- lm(retail.recreation.mean ~ mobility.mean, data = mobility.active.top)
...
grocery.pharmacy.mobility.top.lm <- lm(grocery.pharmacy.mean ~ mobility.mean, data = mobility.active.top)
...
# parks  
parks.mobility.top.lm <- lm(parks.mean ~ mobility.mean, data = mobility.active.top)
...
# transit
transit.mobility.top.lm <- lm(transit.mean ~ mobility.mean, data = mobility.active.top)
...
# workplace
workplace.mobility.top.lm <- lm(workplace.mean ~ mobility.mean, data = mobility.active.top)
...
# residential
residential.mobility.top.lm <- lm(residential.mean ~ mobility.mean, data = mobility.active.top)
...
mobility.active.bottom.lm <- lm(active.mean ~ mobility.mean, data = mobility.active.bottom)
mobility.active.bottom.res <- residuals(mobility.active.bottom.lm)

# retail and recreation
retail.mobility.bottom.lm <- lm(retail.recreation.mean ~ mobility.mean, data = mobility.active.bottom)
...
# grocery and pharmacy
grocery.pharmacy.mobility.bottom.lm <- lm(grocery.pharmacy.mean ~ mobility.mean, data = mobility.active.bottom)
...
# parks
parks.mobility.bottom.lm <- lm(parks.mean ~ mobility.mean, data = mobility.active.bottom)
# below is lm(residual ~ residual)
...
# transit
transit.mobility.bottom.lm <- lm(transit.mean ~ mobility.mean, data = mobility.active.bottom)
# below is lm(residual ~ residual)
...
# workplace
workplace.mobility.bottom.lm <- lm(workplace.mean ~ mobility.mean, data = mobility.active.bottom)
...
# residential
residential.mobility.bottom.lm <- lm(residential.mean ~ mobility.mean, data = mobility.active.bottom)
...
residential.bottom.graph <- ggplot(data=residential.bottom.df,aes(x=residential.bottom.res,y=mobility.active.bottom.res)) +
#  geom_jitter(colour="dark green", alpha=0.7) +
  geom_smooth(method = "lm",
              formula = y ~ x,
              col = "dark green") +
...
residential.bottom.graph <- ggplot(data=mobility.active.bottom,aes(x=residential.mean,y=mobility.mean)) +
#  geom_jitter(colour="dark green", alpha=0.7) +
  geom_smooth(method = "lm",
              formula = y ~ x,
              col = "dark green") +
  labs(x = "residential.mean",
       y = "mobility.mean") +
  theme_bw() +
  ggtitle("linear regression of population density on mortality rates")

mobility.active.graph <- ggplot(data=mobility.active.bottom,aes(x=mobility.mean, y=active.mean)) +
#  geom_jitter(colour="dark green", alpha=0.7) +
  geom_smooth(method = "lm",
              formula = y ~ x,
              col = "dark green") +
  ...
  theme_bw() +
  ggtitle("linear regression of mobility mean on COVID-19 active cases mean")
