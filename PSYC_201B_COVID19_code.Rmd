...
covid.time.series.nas <- covid.time.series.2 %>%
  ...
  filter(retail_and_recreation_percent_change_from_baseline <= 300 & 
           grocery_and_pharmacy_percent_change_from_baseline <= 300 & 
           transit_stations_percent_change_from_baseline <= 300 & 
